...
<html>
<head>
	<title>Profil Enseignant-Candidat</title>
	<meta charset="utf-8">
...
<body onload=<?php echo $_SESSION["division"]?>>
	<header >
		...
		<h1 style="text-align:center; color:#b1cdcd; font-family:Georgia;text-shadow:2px 2px 4px #334d4d;"><i style="font-size:50px;color:#336699;text-shadow:2px 2px 4px #334d4d;" class='fas'>&#xf4ff;</i>Espace de candidature</h1>
	...
	<nav > 
		...
		<i style="font-size:35px;color:#001a33;margin-left:500px;text-shadow:2px 2px 4px #334d4d;" class='far'> &#xf15c;</i>
		<b style="font-size:20px;color:#001a33;text-shadow:2px 2px 4px #334d4d;">N°:  <?php  echo $_SESSION["num_candidature1"]?> </b> 
		
		<i style="font-size:35px;color:#001a33;margin-left:340px;text-shadow:2px 2px 4px #334d4d;" class='fas'> &#xf2bd;</i>
        <b style="font-size:20px;color:#001a33;text-shadow:2px 2px 4px #334d4d;"><?php  echo $_SESSION["prenom"]."  ".$_SESSION["nom"] ?></b> 
	...
	<div class="form1_div">
		...
		<div class="form_zone" id="page_acceuil">
			<p>
				<center><h4><b> BIENVENUE DANS L'ESPACE DE CANDIDATURE DU PROFIL ENSEIGNANT </h4></b></center>
			</p>
			<br>
			<br><br>
		...
		<div class="form_zone" id="rens_person">  
			<form action="enseignant_server.php" method="post" enctype="multipart/form-data">
				<br><br>
				...
				<div class="row">
			    	...
			    	<div class="col-30-left">
			      		<input type="text" id="prenom_fr" name="firstname_fr" placeholder="Votre prénom..." value=<?php  echo $_SESSION["prenom"]?>>
			   		</div>
			  	...
			  	<!-- Le nom en arabe et en français-->
			   	...
			   	<div class="row">
			    	...
			    	<div class="col-30-left">
			      		<input type="text" id="nom_fr" name="lastname_fr" placeholder="votre nom.." value=<?php  echo $_SESSION["nom"]?>>
			    	</div>
			    ...
			    <div class="row">
			    	...
			    	<div class="col-30-left">
			   		...
			   		<input type="submit" name="enregistrer1" value="Enregister">
			</form>
		...
		<div class="form_zone" id="detail_contact">  
			...
			<form action="enseignant_server.php" method="post">
				...
				<input type="submit" value="Enregister" name="enregistrer2">
			</form>
		...
		<div class="form_zone" id="enseignement"> 
			...
			<?php } ?>
			 	...
			 	<input type="submit" value="Enregister" name="enregistrer3">
		...
		<div class="form_zone" id="qualification">
			<form action="enseignant_server.php" method="post" enctype="multipart/form-data">
			    ...
			    <div class="row">
			    	...
			    	<div class="col-35-left">
			      		<input type="text" id="jury2" name="jury2" >
			    	</div>
			    </div>
			    	<!--#####################################################-->
			    ...
			    <input type="submit" value="Enregister" name="enregistrer4">
			</form>
		...
		<div class="form_zone" id="experience">  
			<form action="enseignant_server.php" method="post" enctype="multipart/form-data">
			    ...
			    <input type="submit" value="Enregister" name="enregistrer5" >
	...
	<div class="menu_bar" id="menu_bar">
		<ul>
		  <li class="tab active" onclick="affi1()"><a href="#page_acceuil" onclick="remplacer(this.href.nodeValue)"><span class="glyphicon glyphicon-home" style="font-size:30px;color:white;text-shadow:2px 2px 4px white;"></span>  <b> Page d'accueil</b></a></li>

		  <li class="tab" onclick="affi2()"><a href="#rens_person"><i style="font-size:30px;color:white;text-shadow:2px 2px 4px white;" class="fa">&#xf2bc;</i> <b>Renseignement personnel</b></a></li>

		  <li class="tab" onclick="affi3()"><a href="#detail_contact"><i style="font-size:30px;color:white;text-shadow:2px 2px 4px white;" class="fa">&#xf2ba;</i>   <b>Détails de contact</b></a></li>

		  <li class="tab" onclick="affi4()"><a href="#enseignement"><i style="font-size:30px;color:white;text-shadow:2px 2px 4px white;" class="fa">&#xf02d;</i>  <b> L'objet de candidature</b></a></li>

		  <li class="tab" onclick="affi5()"><a href="#qualification"><i style="font-size:30px;color:white;text-shadow:2px 2px 4px white;" class="fa">&#xf19d;</i>  <b>Qualification académique</b></a></li>

		  <li class="tab" onclick="affi6()"><a href="#experience"><i style="font-size:30px;color:white;text-shadow:2px 2px 4px white;" class='fas'>&#xf0b1;</i>  <b>Expérience professionnelle</b></a></li>
		</ul>
