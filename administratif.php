...
<html>
<head>
	<title>Profil Administratif-Candidat</title>
	<meta charset="utf-8">
...
<body onload=<?php echo $_SESSION["division"]?>>
	...
	<nav > 
		...
		<b style="font-size:20px;color:#001a33;text-shadow:2px 2px 4px #334d4d;">N°:  <?php  echo $_SESSION["num_candidature"]?> </b> 
	...
	<div class="form1_div">
		...
		<div class="form_zone" id="page_acceuil">
			<p>
				<center><h4><b> BIENVENUE DANS L'ESPACE DE CANDIDATURE DU PROFIL ADMINISTRATIF </h4></b></center>
			</p>
			<br>
			<br><br>
		...
		<div class="form_zone" id="rens_person">  
			<form action="administratif_server.php" method="post" enctype="multipart/form-data" >
				<br><br>
		...
		<div class="form_zone" id="detail_contact">  
			...
			<form action="administratif_server.php" method="post" >
				<br><br>
			    <div class="row">
			    	<div class="col-15-left">
		...
		<div class="form_zone" id="enseignement"> 
			...
			<?php foreach ($_SESSION["array_poste"] as $v){?>
		...
		<div class="form_zone" id="qualification">
			<form action="administratif_server.php" method="post" enctype="multipart/form-data">
				<div class="row">
				    ...
				    <p> <h3> <b>Diplôme correspondant au post recherché :</b></h3> </p>
...
<br>
		...
		<!-- ############################### FIN Expérience########################################"-->
			...
			<div class="type_profil">
				<center><b> Profil Administratif</b></center>
			</div>
