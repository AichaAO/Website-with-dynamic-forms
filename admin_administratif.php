...
<html>
<head>
	<title>Profil Administratif-Admin</title>
	<meta charset="utf-8">
...
<body onload="affi1()">
	...
	<div class="form1_div">
		...
		<div class="form_zone" id="page_acceuil">
			<br>
			<p>
				<center><h4><b> BIENVENUE DANS L'ESPACE DE GESTION DU PROFIL ADMINISTRATIF </h4></b></center>
			</p>
			<br>
			...
			<br><br><br>
			<input type="submit" value="téléchrger la base de données des candidats 'administratif' sous format excel" name="database_ad">
			</form>
		...
		<div class="form_zone" id="rens_person">  
			<form action="/" method="post">
			    ...
			    <div class="row">
			    	...
			    	<div class="col-15-left">
			      		<label for="cin_pdf">Votre CIN (PDF)<span class="req">*</span></label>
			    	</div>
...
<br>
		...
		<div class="form_zone" id="experience">  
			<form>
			    ...
			    <div class="row">
			    	<div class="col-35-left">
			      		<label for="decrire_experience" > Déscription de l'expérience <span class="req">*</span> </label>
			    	</div>

			    	<div class="col-55-left">
			    		<textarea name="decrire_experience" rows="10" cols="100" > Votre text ici....
						</textarea>
			    	</div>
